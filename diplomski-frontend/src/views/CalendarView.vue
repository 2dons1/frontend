<template>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(week, index) in calendar" :key="index">
              <td v-for="day in week" :key="day.date" :class="getCellClasses(day)" @click="showTaskDescription(day)">
    ...
    <Dialog v-model:visible="visible" modal :style="{ width: '85vw' }">
      <div class="report-info">
        ...
        <p> <b>Napomena izvođača: </b> <br>{{ currentAssignment.Report.remark }}</p>
        </div>
        <div v-else>
        ...
        <div>
        <div class="footer">
            <Button style="margin-right: 0.5rem;" v-if="!currentAssignment.Report.remark" label="Napiši napomenu" icon="pi pi-comment" severity="secondary" 
