    ...
    methods: {
        ...
        async report(){
            try{
                ...
                const response = (await ReportService.post({description: this.location_report.description, LocationId: this.lastLocation.id})).data
                ...
                if(response){
                    ...
                    // Reset the form
                    this.location_report.description = ""

                    this.$toast.add({ severity: 'success', summary: 'Uspjeh', detail: "Uspješno prijavljen problem", life: 3000 });
                }
